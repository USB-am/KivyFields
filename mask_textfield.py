...
class MaskField(MDTextField):
    ...
    def __init__(self, mask: str, symbol: str, only_digits: bool=False, **kwargs):
        self.mask = mask
        self.symbol = symbol
...
class TestApp(MDApp):
    def build(self):
        return MaskField(mask='+7 (___) ___-__-__', symbol='_', only_digits=True,
                         hint_text='Custom textfield')
